...
export const routes: Routes = [
  ...
  { 
    path: 'upload-excel', 
    loadComponent: () => import('./modules/upload-excel/upload-excel').then(m => m.UploadExcelComponent), 
    canActivate: [AuthGuard] 
  },
  { 
    path: 'lead-profile/:id', 
    loadComponent: () => import('./modules/dashboard/components/lead-profile/lead-profile.component').then(m => m.LeadProfileComponent), 
    canActivate: [AuthGuard] 
  },
  {
    path: 'drive',
  ...
  },
  {
    ...
    loadComponent: () => import('./modules/buyer/component/buyerprofile').then(m => m.BuyerprofileComponent),
    canActivate: [AuthGuard]
  },
  {
    path: '**',
